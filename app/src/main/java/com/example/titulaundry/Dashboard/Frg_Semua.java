...
public class Frg_Semua extends Fragment {
    ...
    public void cariPesananSemua(){
        ...
        searchPesanan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                System.out.println(id_user);
                ApiInterface apiInterface = AppClient.getClient().create(ApiInterface.class);
                Call<SemuaPesanan> pesananCall = apiInterface.getCariPesananSemua(id_user,getTglMulai.getText().toString(),getTglAkhir.getText().toString());
                pesananCall.enqueue(new Callback<SemuaPesanan>() {
                    @Override
                    public void onResponse(Call<SemuaPesanan> call, Response<SemuaPesanan> response) {
                        if (response.body().getKode()==1){
